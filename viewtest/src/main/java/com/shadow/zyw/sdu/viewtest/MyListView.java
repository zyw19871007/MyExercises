...
public class MyListView extends ListView implements View.OnTouchListener,GestureDetector.OnGestureListener{
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
        if (!isDelShown && Math.abs(velocityX) > Math.abs(velocityY)) {
            deleteBtn = LayoutInflater.from(getContext()).inflate(R.layout.del_btn, null);
            deleteBtn.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    deleteBtn=null;
                    isDelShown=false;
                    onDelListener.onDelete(selectedItem);
            ...
            itemLayout.addView(deleteBtn,layoutParams);
            isDelShown=true;
